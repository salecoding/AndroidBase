...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 边角线颜色
     */
    public int mLineColor = getResources().getColor(R.color.colorPrimary);
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x00FFFFFF, getResources().getColor(R.color.colorPrimary), 0x00FFFFFF};
